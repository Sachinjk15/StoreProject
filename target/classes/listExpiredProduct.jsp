                ...
                <div class="col-md-10">
                    <div class="box" id="contact">
						...
						<table class="table table-hover">
							...
							<c:forEach items="${expiredProductList}" var="product">
							
							
                            	<c:set var="dt1" value="<%= new java.util.Date().getTime() %>" />
								     	
								<c:set var="dt2" value="${product.getOfferEndTime().getTime() }" />
								 ...
								 <c:if test="${dt1>=dt2}"> 
	                           		<tbody>
					                    <tr>
											...
											<%-- <td><a href="<c:url value="/deleteProduct.html?productId=${product.getProductId()}" />">Delete </a></td> --%>
