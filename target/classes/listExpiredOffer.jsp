                    ...
                    <div class="box" id="contact">
						...
						<div class="table-responsive">
							<table class="table table-hover">
								...
								<c:forEach items="${expiredOfferList}" var="mainOfferList">
							
							
                            	<c:set var="dt1" value="<%= new java.util.Date().getTime() %>" />
								     	
								<c:set var="dt2" value="${mainOfferList.getOfferEndTime().getTime() }" />
								   ...
								   <tbody>
										<tr>
											...
											<td><a href="<c:url value="/editMainOffer.html?mainOfferId=${mainOfferList.getMainOfferId()}"  />" class="btn btn-info">Edit </a></td>
