               ...
               <c:choose>
					  <c:when test="${not empty pagedListHolder.pageList}">
			                <div class="row products">
				                ...
				                <c:url value="/hotelFood.html?type=hotelFood" var="pagedLink">
				               ...
				               <c:forEach items="${pagedListHolder.pageList}" var="store">
                                ...
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<spring:url value="/${store.storeId}.html?productType=hotel"/>">
                               ...
                               <div>
                                ...
                                <div class="text-center">
                                    ...
                                    <h4><a href="<spring:url value="/${store.storeId}.html?productType=hotel"/>">${store.getStoreName()}</a></h4>
