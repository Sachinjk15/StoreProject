        ...
        <div id="content">
            <div class="container-fluid">
                ...
                <c:choose>
	                ...
	                <c:url value="/luggageAndBagsFashion.html?type=luggageFashion" var="pagedLink">
				          ...
				          <div class="col-md-2 col-sm-4">
				              <div class="product" data-animate="fadeInDown">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<spring:url value="/${store.storeId}.html?productType=luggage"/>">
                               ...
                               <div>
                                ...
                                <div class="text-center">
                                    ...
                                    <h4><a href="<spring:url value="/${store.storeId}.html?productType=luggage"/>">${store.getStoreName()}</a></h4>
