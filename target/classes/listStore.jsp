						...
						<table class="table table-hover">
							...
							<tbody>
								<tr>
									...
									<td><a href="<c:url value="/editStore.html?storeId=${store.getStoreId()}"  />" class="btn btn-info">Edit </a></td>
									<td><button class="btn btn-danger"
	                                         			 onclick="confirmDelete('${pageContext.request.contextPath}/deleteStore.html?storeId=${store.getStoreId()}')">Delete</button></td>
