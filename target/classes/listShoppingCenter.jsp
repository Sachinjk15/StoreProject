						...
						<table class="table table-hover">
							<thead class="thead-inverse">
								<tr>
									...
									<th>Shopping Center City</th>
									<th>Shopping Center Pincode</th>
									<th>Shopping Center Type</th>
									<th>Shopping Center Entry Date</th>
								</tr>
							</thead>
							<c:forEach items="${shoppingCenterList}" var="shoppingCenter">
							<tbody>
							<tr>
								<td>${shoppingCenter.getShoppingCenterId()}</td>
								<td>${shoppingCenter.getShoppingCenterName()}</td>
								<td>${shoppingCenter.getShoppingCenterCity()}</td>
								<td>${shoppingCenter.getShoppingCenterPincode()}</td>
								<td>${shoppingCenter.getShoppingCenterType()}</td>
								<td>${shoppingCenter.getShoppingCenterEntryDate()}</td>
								<td><a href="<c:url value="/editShoppingCenter.html?shoppingCenterId=${shoppingCenter.getShoppingCenterId()}"  />" class="btn btn-info">Edit </a></td>
								<td><button class="btn btn-danger"
                                         			 onclick="confirmDelete('${pageContext.request.contextPath}/deleteShoppingCenter.html?shoppingCenterId=${shoppingCenter.getShoppingCenterId()}')">Delete</button></td>
