        ...
        <div id="content">
            <div class="container-fluid">
                ...
                <c:choose>
	                ...
	                <c:url value="/playEntertainment.html?type=playEntertainment" var="pagedLink">
		               ...
		               <c:forEach items="${pagedListHolder.pageList}" var="store">
                                ...
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<spring:url value="/${store.storeId}.html?productType=play"/>">
                               ...
                               <div>
                                ...
                                <div class="text-center">
                                    ...
                                    <h4><a href="<spring:url value="/${store.storeId}.html?productType=play"/>">${store.getStoreName()}</a></h4>
