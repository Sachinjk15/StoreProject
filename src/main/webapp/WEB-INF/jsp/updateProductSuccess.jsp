 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-10">
                    <div class="box" id="contact">
						...
						<center><h2><font color="green">You have updated <u>${product.getProductName()} </u> Product Successfully !!!!!</font></h2></center>
							<hr>
							<center><h3>Updated Following  Product</h3></center>
							...
							<div class="table-responsive">
								<table  class="table">
										...
										<tr>
											...
											<td>${product.getProductPriority()}</td>
							...
							<div class="text-center">
								<a href="addProduct.html" class="btn btn-success" role="button">OK</a>
							</div>
                    </div>
               </div>
