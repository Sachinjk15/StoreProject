        ...
        <div id="content">
            <div class="container-fluid">
                ...
                <div class="row products">
	                ...
	                <c:url value="/shopingStreetMalleshwaram.html?type=malleshwaramStreet" var="pagedLink">
	                        ...
	                        <div class="col-md-2 col-sm-4">
	                            <div class="product" data-animate="fadeInDown">
	                                ...
	                                <div class="text">
	                                    ...
	                                    <p class="buttons">
	                                        <a href="<spring:url value="/${store.storeId}.html?productType=malleswaram"/>" class="btn btn-default">View detail</a>
	                                    </p>
	                                </div>
