 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-10">
                    <div class="box" id="contact">
						 	<form:form  action="searchShoppingCenter.html" method="post" modelAttribute="shoppingCenter">
							 		<table class="table">
								 		<tr>
								 			<td>Shopping Center Name</td>
								 			<td>:</td>
								 			<td><input type="text" name="shoppingCenterName"></td>
									  ...
									  <table  class="table">
									 	...
									 	<c:forEach items="${shoppingCenterList}" var="shoppingCenter">
									 		<tr>
									 			...
									 			<td><a href="addStore.html?id=${shoppingCenter.getShoppingCenterId()}">Add Store to this Shopping Center</a></td>
