        ...
        <div id="content">
            <div class="container-fluid">
                ...
                <c:choose>
	                ...
	                <c:url value="/mantriShoppingStreets.html?type=shoppingStreet" var="pagedLink">
	                	<c:param name="p" value="~" />
				               ...
				               <c:forEach items="${pagedListHolder.pageList}" var="store">
                                ...
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<spring:url value="/${store.storeId}.html?productType=ShoppingStreet"/>">
                               ...
                               <div>
                                ...
                                <div class="text-center">
                                    ...
                                    <h4><a href="<spring:url value="/${store.storeId}.html?productType=ShoppingStreet"/>">${store.getStoreName()}</a></h4>
