            ...
            <div class="container">
		             <div class="col-md-6 col-md-offset-3">
		                    <div class="box">
		                        ...
		                        <form:form  id="signupForm" action="signup.html" method="post" commandName="user">
		                       
		                            <div class="form-group">
		                                <form:label for="name" path="name">Name:<font color="red">*</font></form:label>
		                                <form:input  class="form-control" id="name" path="name" placeholder="Your Name" />
		                                 <font color = "red"><form:errors path="name" cssClass="error" /></font>
		                            </div>
		                             <div class="form-group">
		                                <form:label for="phone" path="phone">Phone Number:<font color="red">*</font></form:label>
		                                <form:input  class="form-control" id="phone" path="phone" placeholder="Your Mobile Num."/>
		                                <font color = "red"><form:errors path="phone" cssClass="error" /></font>
		                            </div>
		                            
		                            
		                            <div class="form-group">
		                                <form:label for="email" path="email">Email:<font color="red">*</font></form:label>
		                                <form:input  class="form-control" id="email" path="email"  placeholder="Your Email"/>
		                            ...
		                            <div class="form-group">
		                                ...
		                                <form:input type="password" class="form-control" id="password" path="password" placeholder="Your Password"/>
		                                <font color = "red"><form:errors path="password" cssClass="error" /></font>
		                            </div>
		                            
		                           <%--  <div class="form-group">
		                                <form:input type="checkbox" class="form-control" id="password" path="termsAndCondition" required="true"/>
		                                <form:label for="password" path="password">I Agree<font color="red">*</font></form:label>
		                                <font color = "red"><form:errors path="termsAndCondition" cssClass="error" /></font>
		                            </div> --%>
		                            
		                            <div class="form-group">
		                                
		                                <input type=checkbox id="terms" checked> I accept terms and condition.</input>
		                                
		                            </div>
		                            
		                            <div class="text-center">
		                                <button type="submit" class="btn btn-primary" value="Yes" id="yesbutton"
	  ...
	  $('#signupForm').validate({
		  ...
		  messages: {
	            name: {
	            	...
	            	minlength: "Please Enter Your Name with min char 5 !!!"
	            	
	            },
	            
	            phone:{
	            	required :"Please Enter Your Phone Number !!!",
	            	minlength: "Please Enter Your Phone Number with minimum  10 num long!!!",
	            	maxlength: "Please Enter Your Phone Number with max  10 num long!!!"
	            ...
	            terms:{
	            	checked:"Please make sure that checked terms and condition!!!"
	            }
