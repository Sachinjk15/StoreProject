        ...
        <div id="content">
            <div class="container-fluid">
               ...
               <c:choose>
	                ...
	                <c:url value="/sportShoes.html?type=sportsShoesSport"  var="pagedLink">
	               ...
	               <c:forEach items="${pagedListHolder.pageList}" var="store">
                                ...
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front">
                                            <a href="<spring:url value="/${store.storeId}.html?productType=sportsShoes"/>">
                               ...
                               <div>
                                ...
                                <div class="text-center">
                                    ...
                                    <h4><a href="<spring:url value="/${store.storeId}.html?productType=sportsShoes"/>">${store.getStoreName()}</a></h4>
