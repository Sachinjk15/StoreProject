 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-10">
				 ...
				 <hr>
			      	 ...
			      	 <form:form 
			                   action="editStore.html" method="post" modelAttribute="store" enctype="multipart/form-data">
						...
						<div class="table-responsive">
								<table class="table">
									...
									<tr>
						            	<td>Store ID</td>
						                <td><form:input id="storeId" path="storeId"  class="form:input-large"   readonly="true"/></td>
									...
									<tr>
										...
										<td><form:checkbox  path="storeType" id="entertainment" value="cenemaEntertainment" />Cinemas</td>
					            ...
					            <tr>
					             ...
					             <tr>
					                ...
					                <td><form:input path="shoppingCenterId" id="shoppingCenterId" class="form-Control"   readonly="true"/></td>
					            </tr>
					            
					            
					            <tr>
										<td>Store Entry Date</td>
										<td><form:input type="date"  path="storeEntryDate" id="storeEntryDate" readonly="true" /></td>
								</tr>
								...
								<tr>
									<td></td>
						       			<td><button type="submit"  class="btn btn-info" >UPDATE STORE</button></td>
						       	   </tr> 
								</table>
							</div>
