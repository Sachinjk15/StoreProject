               ...
               <div class="container">
                <div class="col-md-6 col-md-offset-3">
                    <div class="box">
                        ...
                        <form  id="forgotPasswordForm" action="resetPassword.html" method="post" onsubmit="return getEmailFunction()">
                            <div class="form-group">
                               	 <label for="password"  >New password<font color="red">*</font></label>
                                 <input type="password" name="password" class="form-control" id="password"  required="true"></input>
                            </div>
                            
                            <div class="form-group">
                                <label for="confirmPassword" >Confirm Password<font color="red">*</font></label>
                                <input type="password" name="confirmPassword" class="form-control" id="confirmPassword" required="true"   ></input>
                            </div>
                             <div class="form-group">
	 	...
	 	$('#forgotPasswordForm').validate({
		  ...
		  messages: {
			  password: {
	            	...
	            	minlength :"Please Enter Min 5 Charecter"
