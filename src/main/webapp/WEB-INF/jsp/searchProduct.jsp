 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-10">
                    <div class="box" id="contact">
						 	...
						 	<form:form  action="searchProduct.html" method="post" modelAttribute="product">
						 	<div class="table-responsive">
						 		<table class="table">
							 		<tr>
							 			<td>Product  Name</td>
							 			<td>:</td>
							 			<td><input type="text" name="productName"  required="true"></td>
								  ...
								  <table  class="table">
									 	...
									 	<c:forEach items="${productList}" var="product">
									 		<tr>
									 			...
									 			<td><a href="addOffer.html?id=${product.getProductId()}">Add Offer to this Product</a></td>
