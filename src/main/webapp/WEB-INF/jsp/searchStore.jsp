 ...
 _________________________________________________________ -->
                ...
                <div class="col-md-10">
                    <div class="box" id="contact">
						 	<form:form  action="searchStore.html" method="post" modelAttribute="store">
							 		<table class="table">
								 		<tr>
								 			<td>Store Name</td>
								 			<td>:</td>
								 			<td><input type="text" name="storeName"  required="true"></td>
									  ...
									  <table  class="table">
									 	...
									 	<c:forEach items="${storeList}" var="store">
									 		<tr>
									 			...
									 			<td><a href="addProduct.html?id=${store.getStoreId()}">Add Product to this Store</a></td>
