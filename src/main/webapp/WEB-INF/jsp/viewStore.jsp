    ...
    <!-- *** NAVBAR END *** -->
	 ...
	 <div id="content">
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        <li><a href="#">Shopping Mall</a> > Stores
                        </li>
                        <!-- <li>Bakery Food</li> -->
                    </ul>
                </div>
                ...
                <div class="row products" >
	                ...
	                <c:url value="/bakeryFood.html?type=bakeryFood" var="pagedLink">
	                        ...
	                        <div class="col-md-2 col-sm-4">
	                            <div class="product" data-animate="fadeInDown">
	                                ...
	                                <div class="text">
	                                    ...
	                                    <p class="buttons">
	                                        <a href="<spring:url value="/${store.storeId}@ShoppingCenter.html?productType=${store.storeType}"/>" class="btn btn-default">View Details</a>
	                                    </p>
	                                </div>
