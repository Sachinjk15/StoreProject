				                        ...
				                        <div class="col-md-2 col-sm-4">
				                            <div class="product" data-animate="fadeInDown">
				                                <div class="flip-container">
				                                    <div class="flipper">
				                                        <div class="front">
				                                             <a href="<spring:url value="/search_${store.storeId}.html"/>">
				                                ...
				                                <div class="text-center">
				                                    <h4> <a href="<spring:url value="/search_${store.storeId}.html"/>">${store.getStoreName()}</a></h4>
				                                   	<h5 class="store_desc">${store.getStoreDescription()}</h5>
				                                   <%-- 
				                                    <p class="buttons">
				                                        <a href="<spring:url value="/search_${store.storeId}.html"/>" class="btn btn-default">View detail</a>
				                                    </p> --%>
				                                </div>
